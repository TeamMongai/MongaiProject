...
chapters.push(chapter)
//------------------
chapter = new Chapter(5, `THE RICK TROLL`)
chapter.add_choice(`start over`, 0)
chapters.push(chapter)
//------------------
...
chapter.add_choice(`Split the sandwich with the troll`, 40)
chapter.add_choice(`Eat the sandwich`, 23)
chapter.add_choice(`Offer the troll the sandwich`, 22)
chapters.push(chapter)
//------------------ 
...
chapter.add_choice(`Angered and horrified, you make a decision to attack`, 3)
chapter.add_choice(`You are flattered that the troll liked your goats so much`, 26)
chapter.add_choice(`Mourn your goats`, 25)
chapters.push(chapter)
//------------------
...
chapter.add_choice(`Let him drown`, 27)
chapter.add_choice(`Pull him to saftey`, 28)
chapter.add_choice(`Throw him the rubber ducky from your bag`, 29)
chapters.push(chapter)
//------------------
...
chapters.push(chapter)
//------------------
chapter = new Chapter(19, `The troll begins taking steps, as though to point you in the direction, you see a rock he's about to trip over. Just before you can get a word out, he has an aneurysm and dies.<br><br>As you stare in disbelief at the fallen troll, you hear a shout of "NOOOO!!!" as his wife and two kids run out from the bushes on the other side of the bridge. Distraught they mourn their father.<br><br>You have only one choice now. Taking responsibility for your actions, you decide to earn the income this family has lost, and take the troll's place on the bridge.<br><br>You become the most feared of all trolls...`)
chapter.add_choice(`...the most infamous of trolls...`, 5)
chapters.push(chapter)
//------------------
chapter = new Chapter(20, `The badger looks at you incredulously, and even more incredulously, it speaks:<br><br>'No one has ever bitten me back! My name is Franklin nice to meet you!'<br><br>cThe badger extends his hand in greeting.`, 4)
chapter.add_choice(`shake Franklin's hand`, 33)
chapter.add_choice(`bite Franklin again`, 35)
chapter.add_choice(`freakout and chuck the badger off the bridge then continue accross, ignoring the troll all together`, 16)
chapters.push(chapter)
//------------------
chapter = new Chapter(21, `When you make it to the other side, you realize you forgot to ask a pretty important question of the troll.<br><br>"Heyyyyyyyyyy" you start, slyly. "I was wondering if..."`)
chapter.add_choice(`"...you've seen my goats?"`, 15)
chapter.add_choice(`"...you would like to be best friends?"`, 14)
chapter.add_choice(`Ask the troll if he knows where a doctor and/or wizard might be`, 19)
chapters.push(chapter)
//------------------
chapter = new Chapter(22, `The troll takes it from you, grumbling that human food is gross. After taking the first bite, however, he pauses and his eyes widen.<br><br>"Sandwiches...sandwiches. This is what my life has been missing. All this time...Trolls would love this!" He turns to you, lettuce caught in his sharp teeth. "Can you get more of these??"<br><br>"More sandwiches?"<br><br>"Yes!"`)
chapter.add_choice(`"I think so"`, 31)
chapter.add_choice(`"No""`, 30)
chapter.add_choice(`"Most definitely"`, 31)
chapters.push(chapter)
//------------------
chapter = new Chapter(23, `You eat the sandwich in front of the troll, clearly enjoying it.<br><br>The troll feels rejected and sad, and begins to cry. Turns out troll tears are quite weighty, and though you try to console him, the tears rapidly increase the flow of the river beneath the bridge.<br><br>You attempt to back away, but you're not fast enough. Water overflows and carries both you and the troll away on the current, never to be seen again.
<br><br>Next time you should probably share.`)
chapter.add_choice(`start over`, 0)
chapters.push(chapter)
//------------------
chapter = new Chapter(24, `You choke back tears. "Yeah. Me too."<br><br>You turn and walk slowly back the way you came, forgetting why you wanted to cross the bridge in the first place.<br><br>One day...<br><br>One day.`)
chapter.add_choice(`start over`, 0)
chapters.push(chapter)
//------------------
chapter = new Chapter(25, `Deeply saddened you sink to your knees and cry "WHY GOD WHYYYYY"<br><br>After drying your tears (and looking like a hot mess), you:`)
chapter.add_choice(`destroy everything the troll ever held dear`, 4)
chapter.add_choice(`goats properly mourned, you attack`, 3)
chapter.add_choice(`Show empathy`, 34)
chapters.push(chapter)
//------------------
chapter = new Chapter(26, `"Yaaaaaaaaaas. Pygmy's the best," you reply. "You have luxurious taste my friend." You high five the troll. "We can count the goats as a toll, right?" you ask, pushing your luck.<br><br>"Whatever floats your goat!" says the troll happily.`)
chapter.add_choice(`Remembering you have a sandwich, you split it with the troll.`, 40)
chapter.add_choice(`Cross the bridge, pushing the troll off as you pass`, 17)
chapter.add_choice(`Feeling generous, you pay anyway.`, 7)
chapters.push(chapter)
//------------------
chapter = new Chapter(27, `After his final panicked kicks, you hear shouts of "NOOOOO" as his wife and two kids run out of the forest on the other side of the bridge. Distraught they mourn their father.<br><br>You have only one choice now. Taking responsibility for your actions, you decide to earn the income this family has lost, and take the troll's place on the bridge.<br><br>You become the most feared of all trolls...`)
chapter.add_choice(`...the most infamous of trolls...`, 5)
chapters.push(chapter)
//------------------

chapter = new Chapter(28, `The troll is sputtering as you pull him out of the water, eyes bulging.<br><br>"You...saved me!!" he manages to get out.<br><br>You brush off your shoulders casually. "Well I wouldn't call myself a hero, but..."<br><br>"You also tried to kill me!" he shouts, standing up. "What is wrong with you??"<br><br>You reply:`)
chapter.add_choice(`"I wanted the advantage in our fight! On guard!"`, 3)
chapter.add_choice(`"Sorry, I'm kind of a psycho. I'll pay you for the trouble if you let me pass."`, 7)
chapter.add_choice(`"I just really didn't want to share my sandwich."`, 23)
chapters.push(chapter)
//------------------
chapter = new Chapter(29, `"Hoping to save the troll without getting your feet wet, you throw him the rubber duck you keep in your bag.<br><br>Unbeknownst to you, however, the rubber duck is actually the troll's one true weakness (well, that and coffee cake. And drowning. Oh! and maybe sharks. Everyone's afraid of sharks).<br><br>The rubber duck glows, a bolt of lightning out of the clear sky strikes the rubber duck and kills the troll. He sinks to the bottom of the river.`)
chapter.add_choice(`...`, 12)
chapters.push(chapter)
//------------------
chapter = new Chapter(30, `"I can't. That was the last sandwich in all the world. And you ate it."<br><br>Turning away from you, the troll cries out in misery.<br><br>"Such a treasure right in front of me, and I devoured it. I don't even deserve to guard this bridge. You can have it."<br><br>The troll walks off, leaving you alone on the bridge. With no more sandwiches, you have nothing left either. You become...`)
chapter.add_choice(`...the most infamous of trolls...`, 5)
chapters.push(chapter)
//------------------
...
chapters.push(chapter)
//------------------
chapter = new Chapter(33, `You can tell you've earned the badger's respect as you shake his little paw. You both realize the troll is still just standing there staring at you.`)
chapter.add_choice(`offer the troll the sandwich from your bag`, 37)
chapter.add_choice(`swing Franklin at the troll`, 38)
chapter.add_choice(`Walk around the troll and across the bridge`, 16)
chapters.push(chapter)
//------------------
chapter = new Chapter(34, `"Well, you must have been awfully hungry..."<br><br>Thinking about it, you remember you have a sandwich in your backpack.`)
chapter.add_choice(`Eat the sandwich`, 23)
chapter.add_choice(`Offer the troll the sandwich`, 22)
chapter.add_choice(`Split the sandwich with the troll`, 40)
chapters.push(chapter)
//------------------
chapter = new Chapter(35, `Franklin, now enraged, attacks viciously, tearing you to shreds.<br><br>Congratulations! You've completed the quest! The only thing is, you're dead.`)
chapter.add_choice(`start over`, 0)
chapters.push(chapter)
//------------------
chapter = new Chapter(36, `When you make it to the other side, you realize you forgot to ask a pretty important question of the troll.<br><br>"Heyyyyyyyyyy" you start, slyly. "I was wondering if..."`)
chapter.add_choice(`"...you've seen my goats?"`, 15)
chapter.add_choice(`"...you would like to be best friends?"`, 14)
chapter.add_choice(`Ask the troll if he knows where a doctor and/or wizard might be`, 19)
chapters.push(chapter)
//-------------------
chapter = new Chapter(37, `The troll takes it from you, grumbling that human food is gross. After taking the first bite, however, he pauses and his eyes widen.<br><br>"Sandwiches...sandwiches. This is what my life has been missing. All this time...Trolls would love this!" He turns to you, lettuce caught in his sharp teeth. "Can you get more of these??"<br><br>"More sandwiches?"<br><br>"Yes!"`)
chapter.add_choice(`I think so`, 31)
chapter.add_choice(`No`, 30)
chapter.add_choice(`Most definitely`, 31)
chapters.push(chapter)
//-------------------
chapter = new Chapter(38, `You grab the handle of the stick Franklin is tied to, anger etched in every crease of his face as you swing him with all your might. Franklin begins violently tearing at the troll. slowly he dies.<br><br>You hear shouts of "NOOOOO" as his wife and two kids run out of the forest on the other side of the bridge. Distraught they mourn their father.<br><br>You have only one choice now. Taking responsibility for your actions, you decide to earn the income this family has lost, and take the troll's place on the bridge.<br><br>You become the most feared of all trolls...`)
chapter.add_choice(`...the most infamous of trolls...`, 5)
chapters.push(chapter)
//-------------------
chapter = new Chapter(39, `When you make it to the other side, you realize you forgot to ask a pretty important question of the troll.<br><br>"Heyyyyyyyyyy" you start, slyly. "I was wondering if..."`)
chapter.add_choice(`"...you've seen my goats?"`, 15)
chapter.add_choice(`"...you would like to be best friends?"`, 14)
chapter.add_choice(`Ask the troll if he knows where a doctor and/or wizard might be`, 19)
chapters.push(chapter)
//-------------------
chapter = new Chapter(40, `Feeling generous, you give half of your sandwich to the troll. You both sit down on either side of the bridge and eat your respective halves.<br><br>As you eat together, you notice a twinkle in the troll's eyes you hadn't seen before. After a long discussion of politics and whether or not you want kids, you decide to get married and live happily ever after.`)
chapter.add_choice(`start over`, 0)
chapters.push(chapter)
//------------
